 ...
 * @author miaoai
 */
@Path("/oauthuser/globus")

public class GlobusRegistrationOAuthUserResource extends AbstractOAuthRegistrationUserResource<GlobusProfile> {

    @Context
    HttpServletRequest request;
    
    @Inject
    public GlobusRegistrationOAuthUserResource(GlobusProvider inProvider) {
        super(inProvider);
    }
